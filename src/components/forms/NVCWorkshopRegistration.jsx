...
class NVCPracticeGroupSide extends React.Component {
  ...
  /** standard renderer */
  render() {
    const { data, pathContext, tags } = this.props
    const {
      getFieldDecorator,
      getFieldsError,
      getFieldError,
    ...
    const hidden = inArray(tags, 'hidden')
                  ...
                  <Fragment>
                    ...
                    {this.state.formSent === false && (
                      ...
                      >
                        ...
                        {/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Experience Level */}
                        <p>Do you have any previous experience with NVC?</p>
                        <FormItem
                        ...
                        {/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Journey */}
                        <p>
                          Please share a few sentences about your NVC journey.
                        </p>
                        <FormItem
...
NVCPracticeGroupSide.propTypes = {
